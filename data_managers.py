...
class sentiment_data_manager:
    """
    Your data butler.
    
    Built for sentiment analysis.
    ...
    [stride]: {16}
        Number of examples to advance the schedule by
    
    """
    def __init__(self, load_path, batch_size=16, stride=16):
